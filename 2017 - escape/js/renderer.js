...
Renderer.prototype = {
	...
	drawDotMatrixScreen : function() {
		...
		if (this.world.message && !this.messageId) { // new message
			...
			"WELCOME TO ESCAPE - THE PINBALL SIMULATION RELEASED FOR JS13KGAMES 2017                  ADD PLAYERS WITH F1-F4, USE DOWN ARROW TO LAUNCH THE BALL, CONTROL FLIPPERS WITH BOTTOM TWO ROWS OF THE KEYBOARD . HIT SPACE TO GENTLY NUDGE THE TABLE .  PRESS P TO PAUSE .                             WINNERS DON'T USE DRUGS" // (25) intro message
			][this.messageId];
		}
